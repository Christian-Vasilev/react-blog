...
function BlogCategories() {
    return (
        <div className='inner-wrapper'>
            <section id='blog-posts' data-theme='default'>
                ...
                <div className='blog-posts'>
                        ...
                        <div className='blog-category-background'>
                            <div className='category-rounded'>
                                <div className='category-image'>
                                    <img src='/resources/images/icons/camera.svg' />
                                </div>
                            </div>
                        </div>
                    ...
                    <div className='blog-category'>
                        <div className='blog-category-background'>
                            <div className='category-rounded'>
                                <div className='category-image'>
                                    <img src='/resources/images/icons/programming.svg' />
                                </div>
                            </div>
                        </div>
                    ...
                    <div className='blog-category'>
                        <div className='blog-category-background'>
                            <div className='category-rounded'>
                                <div className='category-image'>
                                    <img src='/resources/images/icons/design.svg' />
                                </div>
                            </div>
                        </div>
                        ...
                        <div className='container'>
                            <div className='text-heading'>
                                ...
                                <div className='mt-40'>
                                    ...
                                    <button className='btn btn-primary btn-hero ml-15 lift'>Visit my blog</button>
                                </div>
                            </div>
